...
public class SampleView extends ViewPart {
	 ...
	 */
	public static final String ID = "org.py4j.pluginexample.views.SampleView";
	...
	public void createPartControl(Composite parent) {
		...
		PlatformUI.getWorkbench().getHelpSystem().setHelp(viewer.getControl(), "org.py4j.plugin-example.viewer");
